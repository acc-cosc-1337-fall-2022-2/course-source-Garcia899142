...
{
	unique_ptr<TicTacToe> game = make_unique<TicTacToe3>(); // tie game
	...
	unique_ptr<TicTacToe> game1= make_unique<TicTacToe3>(); // x win 1
	game1->start_game("X");
	...
	unique_ptr<TicTacToe> game2= make_unique<TicTacToe3>(); // o first win
	game2->start_game("O");
	...
	unique_ptr<TicTacToe> game3= make_unique<TicTacToe3>(); //o second win
	game3->start_game("O");
	...
	manager.save_game(game3);
		...
		unique_ptr<TicTacToe> game4= make_unique<TicTacToe3>(); //o third win
	game4->start_game("O");
	...
	manager.save_game(game4);
		...
		unique_ptr<TicTacToe> game5= make_unique<TicTacToe3>(); //x second win
	game5->start_game("X");
...
{
	unique_ptr<TicTacToe> game = make_unique<TicTacToe4>(); // tie game
	TicTacToeManager manager;
	game->start_game("X");
	game->mark_board(1);
	REQUIRE(game->game_over()==false);
	...
	unique_ptr<TicTacToe> game1= make_unique<TicTacToe4>(); // x win 1
	game1->start_game("X");
	...
	unique_ptr<TicTacToe> game2= make_unique<TicTacToe4>(); // o first win
			game2->start_game("O");
	...
	unique_ptr<TicTacToe> game3= make_unique<TicTacToe4>(); //o second win
game3->start_game("O");
	...
	manager.save_game(game3);
		...
		unique_ptr<TicTacToe> game4= make_unique<TicTacToe4>(); //o third win
	game4->start_game("O");
	...
	unique_ptr<TicTacToe> game5= make_unique<TicTacToe4>(); //x second win
	game5->start_game("X");
	game5->mark_board(1);//1 for x
	REQUIRE(game5->game_over()==false);
	game5->mark_board(2);//2 for o
